...
function createArticle(content) {
  ...
  first.textContent = content.firstParagraph;
  second.textContent = content.secondParagraph;
  third.textContent = content.thirdParagraph;
...
// Iterate over array and create article component in reference to newly created function
